...
namespace MobileDesktop
{
    public partial class FormThongKeSPThang : Form
    {
        ...
        public void loadproduct()
        {
            ...
            dataGridView1.DataSource = dh.ThongkeSPThang(thang, nam);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
             try
            {
                FormThongKeSPThang excel = new FormThongKeSPThang();
                DataTable dt = GetDataTableFromDGV(dataGridView1);
                    excel.Export(dt, "Bao cao", "BÁO CÁO BÁN HÀNG THÁNG: "+ txtThang.Text);
